...
SOURCE_EXCEL = r"D:\COMMITTEE FORMES\Miza-Monthly\Co_py\Iscour_Report.xlsx"

# Destination directory
DEST_DIR = r"D:\Committee\01 Inform\Reports"


# Text file to sheet mapping
TEXT_FILE_MAPPING = {
    # Format: "text_file_path": ["sheet_name", ["col1", "col2", ...]]
    r"D:\Committee\01 Inform\Reports\Client_Report.txt": ["جديد", ["B", "C", "D", "E","F","G", "H"]],
    r"D:\Committee\01 Inform\Reports\Gur_Report.txt": ["الضامنين", ["B", "C", "D", "E", "F", "G"]]
}
